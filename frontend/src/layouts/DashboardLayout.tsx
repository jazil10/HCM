...
const navigation = [
  { name: 'Dashboard', href: '/dashboard', icon: HomeIcon, roles: [UserRole.ADMIN, UserRole.HR, UserRole.MANAGER, UserRole.EMPLOYEE] },
  { name: 'Employees', href: '/dashboard/employees', icon: UsersIcon, roles: [UserRole.ADMIN, UserRole.HR] },
  { name: 'My Profile', href: '/dashboard/my-profile', icon: UserCircleIcon, roles: [UserRole.MANAGER, UserRole.EMPLOYEE] },
                ...
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4 shadow-xl">
                    <div className="flex h-16 shrink-0 items-center">
                      ...
                      <h1 className="ml-3 text-xl font-bold text-gray-900">HCM</h1>
                    </div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4 shadow-lg border-r border-gray-200">
            <div className="flex h-16 shrink-0 items-center">
              ...
              <h1 className="ml-3 text-2xl font-bold text-gray-900">HCM</h1>
            </div>
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                <li>
          ...
          <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white/95 backdrop-blur-sm px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
              ...
              <div className="flex items-center gap-x-4 lg:gap-x-6">
                <button type="button" className="-m-2.5 p-2.5 text-gray-400 hover:text-gray-500 transition-colors duration-200">
                ...
                <Menu as="div" className="relative">
                  <Menu.Button className="-m-1.5 flex items-center p-1.5 hover:bg-gray-50 rounded-md transition-colors duration-200">
